  ...
  <v-card class="bg-white">
    <div class="card-header py-3">
      <div class="d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Import Dokumen Keputusan</h5>
...
<script>
export default {
  name: "dokumenKeputusanFormImport",
  data() {
    return {
      headers: [
        { text: "No", value: "No" },
  ...
  methods: {
    handleClose() {
      this.$store.commit("SET_JSON_IMPORT_DOKUMEN_KEPUTUSAN", null);
    },
    handleConfirm() {
      this.$store.dispatch("importDokumenKeputusan").then(() => {
        this.handleClose();
      });
    },
  },
